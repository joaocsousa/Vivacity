...
>
> **Where we are:** Milestones M1–M3, M6, and M7 are complete. The app discovers devices, runs Fast Scan and Deep Scan (with filesystem-aware carving for FAT/APFS/HFS+), and streams previews in the UI.
>
> **What to do next:** Current focus is **M8 (Advanced Features: T-027 → T-029)** and **M12 polish/navigation (T-017 & related)**. See `PROJECT_PLAN.md` for ticket details and acceptance criteria.
