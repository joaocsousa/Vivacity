...
final class FATAllocationTableTests: XCTestCase {
    private func createMockFATVolume(
        totalSectors: UInt64,
        ...
        // Cluster 3: Allocated
        writeUInt32(&data, at: fatStart + 12, value: 0x0FFF_FFFF)
        // Cluster 4: Free (Explicitly 0)
        writeUInt32(&data, at: fatStart + 16, value: 0x0000_0000)
        // Cluster 5: Free (Explicitly 0)
        writeUInt32(&data, at: fatStart + 20, value: 0x0000_0000)
        // Cluster 6: Allocated
        writeUInt32(&data, at: fatStart + 24, value: 0x0FFF_FFFF)
    ...
    func testFATAllocationTableParsesValidMap() async throws {
        let volumeData = createMockFATVolume(totalSectors: 600_000)
        ...
        XCTAssertEqual(ranges[0].startOffset, 126_976)
        XCTAssertEqual(ranges[0].length, 8192)
        XCTAssertEqual(ranges[0].endOffset, 126_976 + 8192)
    }
}
